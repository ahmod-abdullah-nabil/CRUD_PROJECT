...
<body>
                ...
                <div class="col-9">
                    ...
                    <nav>
                        <ul class="cd-primary-nav">
                            ...
                            <li><a href="contacts.php" class="animated_link">Contact Us</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
	...
	<main id="general_page">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.3363181975355!2d89.23935301534809!3d24.01920258437042!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe9b369a35dcfb%3A0x3c8cff0140e21bb8!2sPabna%20Polytechnic%20Institute!5e0!3m2!1sen!2sbd!4v1647539751009!5m2!1sen!2sbd" width="100%" height="500px" style="border: 2px;;" allowfullscreen="" loading="lazy">
		</iframe>
		<!-- end map-->
			...
			<div class="row">
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control styled" id="name_contact" name="name_contact" placeholder="Ahmod">
									</div>
								</div>
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										<label>Last name</label>
										<input type="text" class="form-control styled" id="lastname_contact" name="lastname_contact" placeholder="Abdullah">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										<label>Email:</label>
										<input type="email" id="email_contact" name="email_contact" class="form-control styled" placeholder="nabilahmodabdullah@email.com">
									</div>
								</div>
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										<label>Phone number:</label>
										<input type="text" id="phone_contact" name="phone_contact" class="form-control styled" placeholder="+8801996529076">
									</div>
								</div>
							</div>
							<div class="row">
				...
				<aside class="col-lg-4">
					<div class="box_style_2">
						<h4>Contacts info</h4>
						<p>
						<a href="https://goo.gl/maps/Sb4SVvP3tmpnujKB9" target="blank">Polytechnic Road, Pabna 6600, Bangladesh</a>	
							<a href="tel://+8801996529076">+8801996529076</a>
							<br>
							<a href="mailto:nabilahmodabdullah@gmail.com">nabilahmodabdullah@gmail.com</a>
						</p>
						...
						<ul class="contacts_info">
							<li>Administration
								<br>
								<a href="tel://+8801996529076">+8801996529076</a>
								<br><a href="mailto:nabilahmodabdullah@gmail.com">nabilahmodabdullah@gmail.com</a>
								<br>
